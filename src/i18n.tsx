...
const text = {
  en: {
    ...
    homeVoiceMarker: "I like clean systems — but I still leave room for playful ideas.",
    ...
    contactVoiceMarker: "No pitch deck needed — a few honest lines are perfect.",
    intentHiring: "Hiring",
    ...
    caseTlDr: "TL;DR",
    caseVoiceMarker: "If you only skim one part, skim this and you’ll still get the point.",
  ...
  de: {
    ...
    homeVoiceMarker: "Ich mag saubere Systeme — aber ich lasse immer Platz für spielerische Ideen.",
    ...
    contactVoiceMarker: "Kein Pitch-Deck nötig — ein paar ehrliche Zeilen reichen völlig.",
    intentHiring: "Hiring",
    ...
    caseTlDr: "TL;DR",
    caseVoiceMarker: "Wenn du nur einen Abschnitt überfliegst, nimm diesen — dann ist die Richtung trotzdem klar.",
