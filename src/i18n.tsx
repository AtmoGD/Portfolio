...
const text = {
  ...
  de: {
    ...
    heroHeadline: "Ich entwickle Gameplay-Systeme mit Fokus auf robuste Umsetzung und Wartbarkeit.",
    heroSubline: "Schwerpunkt auf klarer Verantwortung, iterativem Prototyping und nachvollziehbaren Ergebnissen.",
    ...
    selectedSystemsTitle: "Ausgewählte Arbeiten mit klarer Verantwortung und nachvollziehbarem Beitrag",
    contactLead: "Kontakt",
    ...
    watch: "Ansehen",
    code: "Code",
    projectsHeader: "Projekte nach Rolle, Zeitraum, Beitrag und Ergebnis",
    projectsSub: "Zuerst die hervorgehobenen Projekte, danach weitere Arbeiten bei Bedarf.",
    ...
    contactTitle: "Kontaktmöglichkeiten für den passenden Austausch",
    contactSub: "Drei klare Einstiege, damit Anfragen schnell im richtigen Kontext ankommen.",
    ...
    recruiterPath: "Recruiter",
    recruiterPathCopy: "Für einen schnellen Abgleich bitte Rolle, Senioritätsniveau und Standort teilen.",
    hiringPath: "Hiring Manager",
