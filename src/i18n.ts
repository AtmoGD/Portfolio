    ...
    resources: {
        en: {
            translation: {
                ...
                aboutMeText: "I'm Dennis, passionate programmer and game developer. I recently graduated with my masters in Game Development and now I am ready to embark on another journey! My academic and personal quests have been fueled not only by my enthusiasm for coding, but by an insatiable curiosity to explore the depths of game design and development!\n\nWhile my journey has included excursions into the worlds of augmented and virtual reality, adding a dash of futuristic technology to my experience, my heart remains anchored to the core of game development. During my education and free time I have been part of several game projects and had the opportunity to experiment and hone my skills.\n\nUltimately, It's the thrill of coding, the creative process and the collaborative spirit of development that truly drives my passion.\n\nGame jams are my happy place. I've learnt the art of turning coffee into code - literally. These caffeinated marathons have not only honed my ability to work under pressure, but also taught me the value of teamwork and the sheer joy of bringing game ideas to life against the clock. I relish the challenge of navigating complex problems, firmly believing that every hurdle is a stepping stone to innovation.\n\nI'm looking for new and challenging opportunities where  I can combine my  technical skill, creative vision and genuine enthusiasm to create unique experiences. I'm eager to join a team where we inspire each other and maybe even redefine gaming as we know it. So let's make something unforgettable together, powered by innovation, collaboration and, of course, a good cup of coffee",
        ...
        de: {
            translation: {
                ...
                aboutMeText: "Ich bin Dennis, leidenschaftlicher Programmierer und Spieleentwickler. Vor kurzem habe ich meinen Master in Interaktive Mediensysteme -/ Game Development abgeschlossen und bin nun bereit, eine neue Reise anzutreten! Mein akademisches und persönliches Streben wurde nicht nur durch meine Begeisterung für das Programmieren angetrieben, sondern auch durch eine unstillbare Neugier, die Tiefen des Gamedesigns und der Entwicklung zu erforschen!\n\nAuch wenn meine Reise Ausflüge in die Welt von AR und VR beinhaltet, die meiner Erfahrung einen Hauch von futuristischer Technologie hinzufügen, bleibt mein Herz im Kern der Spieleentwicklung verankert. Während meiner Ausbildung und in meiner Freizeit habe ich an mehreren Spieleprojekten mitgewirkt und hatte die Gelegenheit, zu experimentieren und meine Fähigkeiten zu verbessern.\n\nLetztendlich sind es der Nervenkitzel des Programmierens, der kreative Prozess und der kollaborative Geist der Entwicklung, die meine Leidenschaft ausmachen.\n\nGame Jams sind mein Glücksort. Ich habe die Kunst erlernt, Kaffee in Code zu verwandeln - im wahrsten Sinne des Wortes. Diese koffeinhaltigen Marathons haben nicht nur meine Fähigkeit, unter Druck zu arbeiten, geschärft, sondern mir auch den Wert von Teamarbeit und die Freude an der Verwirklichung von Spielideen gegen die Zeit vermittelt. Ich genieße die Herausforderung, komplexe Probleme zu bewältigen, und glaube fest daran, dass jede Hürde ein Sprungbrett zur Innovation ist.\n\nIch bin auf der Suche nach neuen und herausfordernden Möglichkeiten, bei denen ich mein technisches Können, meine kreative Vision und meinen echten Enthusiasmus kombinieren kann, um einzigartige Erfahrungen zu schaffen. Ich bin begierig darauf, einem Team beizutreten, in dem wir uns gegenseitig inspirieren und vielleicht sogar das Gaming, wie wir es kennen, neu definieren. Lassen Sie uns also gemeinsam etwas Unvergessliches schaffen, angetrieben von Innovation, Zusammenarbeit und natürlich einer guten Tasse Kaffee.",
