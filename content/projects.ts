...
/**
 * Projects in chronological order, newest first. Intra-year ordering follows
 * actual jam/release month (e.g. Cozy Winter Jam in January comes before
 * Cozy Fall Jam in October of the same year, newer-first).
 * Coffee.exe stays pinned to the end regardless of year.
 */
export const projects: Project[] = [
  {
    ...
    roleKey: "programmer",
    teamSize: 4,
    duration: "4 days (Easter jam)",
    context: "Hobby",
    category: "game",
    tagKeys: ["unity", "hobby", "gameDesign"],
  ...
  },
  {
    ...
    tagKeys: ["unity", "cozy", "gameJam", "gameDesign"],
    techKeys: ["unity", "programming", "gameDesign"],
    externalLink: "https://atmogd.itch.io/sock-it-up",
    linkLabel: "play",
    descriptionKey: "projects.descriptions.sockItUp",
    accent: "violet",
  },
  {
